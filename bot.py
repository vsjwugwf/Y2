...
class UserSettings:
    ...
    incognito_mode: bool = False        # ★ حالت ناشناس
...
class SessionState:
    ...
    # شناسه آخرین پیام تنظیمات برای ویرایش
...
def setup_audio_loop():
    ...
    try:
        ...
        safe_print("snd-aloop not available, trying pulseaudio")
